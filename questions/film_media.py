...
FILM_MEDIA_QUESTIONS = [
    {
        ...
        "key": "film-1",
        "options": ["Yes", "No"],
        "depends_on": [("industry", "Film and Media")],
        "eligible": [(FILM_TAX_CREDIT_PROGRAM, "Yes")]
    },
    {
    ...
    },
    {
        ...
        "options": ["Yes", "No"],
        "depends_on": [("industry", "Film and Media")],
        "eligible": [(FILM_TAX_CREDIT_PROGRAM, "No")]
    },
    {
    ...
    },
    {
        ...
        "options": ["Yes", "No"],
        "depends_on": [("industry", "Film and Media")],
        "eligible": [(DIGITAL_MEDIA_TAX_CREDIT_PROGRAM, "Yes")]
    },
    {
